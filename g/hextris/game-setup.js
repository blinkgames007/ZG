...
const GAME_DATA = {
  ...
  plays: "100K+ Plays",
  bannerImage: "sl/banner.png",
  icon: "favicon.ico",
  playLink: "main.html",
  description:
    "Hextris is not your average platformer — it’s a rage-filled challenge that tests your patience and timing at every step!",

  features: [
    "An addictive puzzle game inspired by Tetris.",
    "Here you can play Hextris Puzzle. Hextris Puzzle is one of our selected Puzzle Games.",
